...
def ode_RK4(m1,m2,ti,tf,x0,y0,vx0,vy0):
    ...
    def orb_param(sol):
        ...
        p = 2*np.pi*np.sqrt((a1)**3/((ac.G.to('(AU**3)/(solMass year**2)'))*m_sum))  #time-period of Star 1 in year
...
ode_RK4(6,2,0,2.82,-0.1,0,0,-45.89)